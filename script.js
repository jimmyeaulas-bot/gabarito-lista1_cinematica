  ...
  cinematica: {
    ...
    items: [
      ...
      },
      {
        ...
        formulaTexto: "v = v₀ + a · t",
        descricao: "Determina a velocidade final no MRUV tendo o tempo decorrido."
      },
      {
        id: "sorvetao",
        badge: "MRUV",
        concept: "Posição / Deslocamento (Sorvetão)",
        formulaTexto: "ΔS = v₀ · t + ½ · a · t²  ou  S = S₀ + v₀ · t + ½ · a · t²",
    ...
    questoes: [
      {
        ...
        fase3: [
          "Substituindo os dados: S = 120 + 15 · 4",
      ...
      },
      {
        ...
        fase3: [
          ...
          "Substituição na fórmula: ΔS = 15 · 480",
          "Multiplicação direta: ΔS = 7.200 metros (Alternativa C)."
        ]
      },
      {
        numero: 3,
        ...
        fase2: {
          ...
          formula: "a_m = Δv / Δt = (v - v₀) / Δt",
          motivo: "Temos a variação da velocidade em um determinado intervalo de tempo."
        },
        fase3: [
          "Variação de velocidade: Δv = 30 - 6 = 24 m/s",
          "Aplicação da fórmula: a_m = 24 / 6",
      ...
      },
      {
        ...
        fase3: [
          "Substituindo na equação: ΔS = 4 · 5 + ½ · 2 · (5²)",
          "Resolvendo as potências e parcelas: ΔS = 20 + 1 · (25)",
          "Somando os termos: ΔS = 20 + 25 = 45 metros (Alternativa D)."
        ]
      },
      {
        numero: 5,
        ...
        fase3: [
          ...
          "Isolando t: 30t - 10t = 140 - 20 ➔ 20t = 120 ➔ t = 6 segundos (momento do encontro)",
          "Determinando a posição no móvel A: S₁ = 20 + 30(6) = 20 + 180 = 200 metros",
          "Verificação no móvel B: S₂ = 140 + 10(6) = 140 + 60 = 200 metros (Alternativa C)."
        ]
      }
    ]
  },
  ...
  B: {
    ...
    questoes: [
      ...
      },
      {
        ...
        fase3: [
          "Isolando o tempo na equação: Δt = 240 / 12",
          "Divisão direta: Δt = 20 segundos (Alternativa C)."
        ]
      },
      {
        numero: 3,
        ...
        fase3: [
          "Substituição dos valores: 0² = 18² + 2 · (-3) · ΔS",
          "Desenvolvendo: 0 = 324 - 6 · ΔS",
          "Isolando o termo: 6 · ΔS = 324 ➔ ΔS = 324 / 6 = 54 metros (Alternativa C)."
        ]
      },
      {
        numero: 4,
        ...
        fase3: [
          "Substituindo na fórmula: v = 5 + 3 · 4",
      ...
      },
      {
        ...
        fase3: [
          "Substituição na equação: 20² = 10² + 2 · a · 75",
          "Efetuando potências e multiplicações: 400 = 100 + 150 · a",
          "Isolando o termo com a incógnita: 150 · a = 400 - 100 ➔ 150 · a = 300",
          "Divisão final: a = 300 / 150 = 2 m/s² (Alternativa B)."
        ]
      }
    ]
  },
  ...
  C: {
    ...
    questoes: [
      ...
      },
      {
        ...
        fase3: [
          "Substituição direta: ΔS = 9 · 20",
          "Multiplicação: ΔS = 180 metros (Alternativa D)."
        ]
      },
      {
        numero: 3,
        ...
        fase3: [
          "Aplicação da fórmula: v_m = (11 + 25) / 2",
          "Soma do numerador: v_m = 36 / 2",
      ...
      },
      {
        ...
        fase3: [
          "Substituindo na expressão: S = 8 + 2 · (3) + ½ · 4 · (3²)",
          "Resolvendo produtos e potências: S = 8 + 6 + 2 · 9",
      ...
      },
      {
        ...
        fase3: [
          ...
          "Isolando t: t = 120 / 10 = 12 segundos (Alternativa C)."
        ]
      }
    ]
  },
  ...
  D: {
    ...
    questoes: [
      ...
      },
      {
        ...
        correta: 2, // c (Corrigido na auditoria: 72/3.6 = 20 m/s)
        fase1: [
        ...
        fase3: [
          "Cálculo: v = 72 / 3,6",
          "Multiplicando numerador e denominador por 10: 720 / 36",
      ...
      },
      {
        ...
        fase3: [
          "Subtração das velocidades: Δv = 20 - 8 = 12 m/s",
          "Divisão pelo tempo: a_m = 12 / 4",
      ...
      },
      {
        ...
        fase3: [
          "Substituindo valores: ΔS = 3 · 6 + ½ · 2 · (6²)",
          "Calculando parcelas: ΔS = 18 + 1 · 36",
          "Soma: ΔS = 18 + 36 = 54 metros (Alternativa D)."
        ]
      },
      {
        numero: 5,
        ...
        correta: 1, // b (Corrigido na auditoria: 25t = 200 -> t = 8s)
        fase1: [
        ...
        fase3: [
          ...
          "Divisão final: t = 200 / 25 = 8 segundos (Alternativa B)."
        ]
      }
    ]
  },
    ...
    questoes: [
      {
        ...
        fase3: [
          "Substituindo na fórmula: S = 40 + 12 · 7",
      ...
      },
      {
        ...
        correta: 1, // b (Corrigido na auditoria: 36/3.6 = 10 m/s)
        fase1: [
      ...
      },
      {
        ...
        correta: 2, // c (Corrigido na auditoria: (16-4)/3 = 4 m/s²)
        fase1: [
          { termo: "Velocidade inicial (v₀)", valor: "4 m/s" },
        ...
        fase3: [
          "Variação de velocidade: Δv = 16 - 4 = 12 m/s",
          "Dividindo pelo tempo: a_m = 12 / 3",
      ...
      },
      {
        ...
        correta: 2, // c (Corrigido na auditoria: 8 + 2*6 = 20 m/s)
        fase1: [
          { termo: "Velocidade inicial (v₀)", valor: "8 m/s" },
          { termo: "Aceleração constante (a)", valor: "2 m/s²" },
          { termo: "Tempo (t)", valor: "6 s" },
        ...
        fase3: [
          "Substituição na fórmula: v = 8 + 2 · 6",
      ...
      },
      {
        ...
        fase3: [
          ...
          "Agrupando t: 8t + 12t = 150 - 30 ➔ 20t = 120 ➔ t = 6 segundos (instante de encontro)",
          "Calculando a posição em S₁: S₁ = 30 + 8 · (6) = 30 + 48 = 78 metros",
          "Verificação em S₂: S₂ = 150 - 12 · (6) = 150 - 72 = 78 metros (Alternativa C)."
        ]
      }
    ]
  }
